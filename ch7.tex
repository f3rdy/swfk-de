...
Mit dem Parameter \textbf{w} (kommt vom englischen write) sagen wir Python, dass wir auch in die Datei schreiben wollen. Mit der Funktion \code{write}\index{Funktion!Datei!schreiben} können wir nun Information in die Datei schreiben.
...
Wenn wir fertig mit schreiben sind, müssen wir es Python sagen und Python macht dann die Datei zu---wir verwenden dazu die Funktion \code{close}\index{Funktion!Datei!schließen}.
