...
Und so weiter.
\par\noindent
%In terms of an if-statement, we could write that as\texorpdfstring{$\ldots$}{...}
...
\noindent
%\texorpdfstring{$\ldots$}{...}continuing on forever. A simpler way to write the statement would be:
