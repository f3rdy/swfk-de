...
Du kannst in der Python Konsole Multipizieren\index{Multiplikation}, Addieren\index{Addition}, Substrahieren\index{Substraktion} und auch Dividieren\index{Division}, aber auch andere mathematische Funktionen verwenden, auf die wir später eingehen werden. Fürs Erste sind die wichtigsten mathematischen Symbole in Python (eigentlich heißen sie Operatoren\index{Operatoren}):
...
\section{Verwendung von Klammern und die ``Reihenfolge der Operationen''}\index{Reihenfolge von Operatoren}
