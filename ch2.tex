...
%\chapter{8 multiplied by 3.57 equals\texorpdfstring{$\ldots$}{...}}\label{ch:8multipliedby3.57}
...
%\subsection*{\color{BrickRed}\texorpdfstring{$\ldots$}{...}and removing items}\index{lists!removing}
\subsection*{\color{BrickRed}\texorpdfstring{$\ldots$}{...}und Dinge entfernen}\index{Listen!entfernen}
