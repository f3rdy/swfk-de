...
%\noindent
%If you have more than those two directories listed (for example)\texorpdfstring{$\ldots$}{...}
...
%\noindent
%\texorpdfstring{$\ldots$}{...}then you may need to perform the following steps:
...
\noindent
%\emph{\color{BrickRed}After installation\texorpdfstring{$\ldots$}{...}}
