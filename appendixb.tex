...
Somit speichern wir die Länge des Liste in der Variable mit dem Namen `laenge' und verwenden sie in der \code{range} Funktion um unsere Schleife zu erzeugen.
...
Der \code{range} Funktion kannst du auch ein drittes Argument mitgeben. Ein sogenannter Schrittweite (oder step auf englisch). Wenn du da nichts mitgibst, dann wird die Schrittweite 1 verwendet. Lass uns die Schrittweite 2 mitgeben und schauen was passiert:
